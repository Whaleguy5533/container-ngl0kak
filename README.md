...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ngl0kak.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ngl0kak.containers.anotherwebservice.com/
...
```
git clone git@github.com:Whaleguy5533/container-ngl0kak.git
cd container-ngl0kak
```
...
```
docker attach container-ngl0kak
```
